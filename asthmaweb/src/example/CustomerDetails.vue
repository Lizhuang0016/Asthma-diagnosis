<template>
  <div class="details container">
      ...
      <ul class="list-group"> 
          ...
          <li class="list-group-item"><span class="glyphicon glyphicon-asterisk">{{customer.age}}</span></li>
          <li class="list-group-item"><span class="glyphicon glyphicon-asterisk">{{customer.companyId}}</span></li>
      </ul>
      <ul class="list-group"> 
          <li class="list-group-item"><span class="glyphicon glyphicon-asterisk">{{customer.introduction}}</span></li>
      </ul>
  </div>
</template>
